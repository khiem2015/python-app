...
class Register(QWidget):
    def __init__(self):
        ...
        self.btn_login = self.findChild(QPushButton, "btn_login")
        self.btn_register1 = self.findChild(QPushButton, "btn_register1")
        self.btn_eye_p = self.findChild(QPushButton, "btn_eye")
        self.btn_eye_cp = self.findChild(QPushButton, "btn_eye_cp")

        self.btn_eye.clicked.connect(lambda: self.show_password(self.btn_eye_p, self.password_input))
        self.btn_eye.clicked.connect(lambda: self.show_password(self.btn_eye_cp, self.confirm_pass_input))
